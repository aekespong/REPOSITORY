...
> i min bok har jag ett delvis kompletterande och delvis annorlunda angreppssätt. 

> för mig är det centralt med ett tjänstelager med systemtjänster som är komplexa funktioner och verksamhetsnära som namnsätts i verksamhetstermer. De grupperas i domäner. Exemplevis Fordon.Registrering, Fordon.Besiktning och Fordon.Service. Det i sin tur anropar bastjänster som motsvarar data objects som har CRUD-funktionalitet. Dessa CRUD-tjänster måste hållas inom domänen och inte spridas utanför. Det centralt att alla beroenden går nedåt via systemtjänster (system services) mot dessa bastjänster/resurstjänster. Systemtjänster exponeras utanför domänen och det är tillåtet för systemtjänster att nyttja andra systemtjänster, även på resursnivå. 

> Exempel på resursnivå. Fordon.Besiktning.Planeringsschema()

> Hur gör man för att förena detta sätt att tänka med tjänstelager, domäner och systemtjänster med ovanstående? 

---

# Från tjänstelager till semantik 
